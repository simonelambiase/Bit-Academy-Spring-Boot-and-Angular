...
var StudentServiceService = /** @class */ (function () {
    ...
    StudentServiceService.prototype.getStudentById = function (id) {
        return this.client.get("http://localhost:8080/api/studente/" + id)
            .pipe(operators_1.tap(function (data) { return console.log('All: ' + JSON.stringify(data)); }), operators_1.catchError(this.handleError));
    };
    StudentServiceService.prototype.addStudentToDB = function (student) {
        return this.client.post("http://localhost:8080/api/studente", student)
            .pipe(operators_1.catchError(this.handleError));
    };
    StudentServiceService.prototype.updateStudent = function (student) {
        return this.client.put("http://localhost:8080/api/studente/id/" + student.id, student)
            .pipe(operators_1.catchError(this.handleError));
    };
    StudentServiceService.prototype.deleteStudente = function (id) {
